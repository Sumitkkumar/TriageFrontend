                      ...
                      <tr key={key}>
                        ...
                        <td>
                          {(row.wareHouseToRapi === "Success" || row.wareHouseToRapi === "No") ?
                            row.wareHouseToRapi : <p className='showMoreBtn' onClick={() => displayMoreData(key)}>Show More</p>
                          }
                        </td>
                ...
                <>
                  {
                    ...
                    <div className='keyValueContainer'>
                        <span className='pageSubHeadings'>{jsonData.dataflows[selectedDataIndex].dataflowName}</span>
                        <p style={{}}>{jsonData.dataflows[selectedDataIndex].wareHouseToRapi}</p>
